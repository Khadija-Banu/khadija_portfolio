...
@section('content')
    ...
    <div class="container-fluid px-4">
        ...
        <form action="{{route('b_service_update',$service->id)}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row ">
                <div class="form-group col-md-6  mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" id="icon" name="icon" class="form-control" value="{{$service->icon}}">
                    </div>
                    <div class="mb-3">
