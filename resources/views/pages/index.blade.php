...
<html lang="en">
    <head>
        ...
        <title>Khadija's --Portfolio</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="{{'ui/page'}}/assets/favicon.ico" />
        ...
        <link href="{{'ui/page'}}/css/styles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="{{'ui/page'}}/assets/img/navbar-logo.svg" alt="..." /></a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?=$portfolio->id?>">
                                ...
                                <img style="height:40vh; width:45vh" class="img-fluid" src="{{url($portfolio->small_image)}}" alt="..." />
                            </a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{'ui/page'}}/assets/img/logos/microsoft.svg" alt="..." aria-label="Microsoft Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{'ui/page'}}/assets/img/logos/google.svg" alt="..." aria-label="Google Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{'ui/page'}}/assets/img/logos/facebook.svg" alt="..." aria-label="Facebook Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{'ui/page'}}/assets/img/logos/ibm.svg" alt="..." aria-label="IBM Logo" /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" action="{{route('b_contact_store')}}" method="post" >
                    @csrf
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal<?=$portfolio->id?>" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-bs-dismiss="modal"><img src="{{'ui/page'}}/assets/img/close-icon.svg" alt="Close modal" /></div>
                    <div class="container">
        ...
        <!-- Core theme JS-->
        <script src="{{'ui/page'}}/js/scripts.js"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
